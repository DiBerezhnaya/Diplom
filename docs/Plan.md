...
- Срок действия карты: месяц git(число от 01 до 12)/ год (последние цифры текущего или последующих трех лет)
...
2. Заполнение полей валидными данными и карты со статусом APPROVED
- Нажать на кнопку "Купить в кредит"
- В появившихся полях ввести номер карты: 4444 4444 4444 4441
- Ввести валидные данные в остальные поля
- Нажать на кнопку "Продолжить" 

 *Ожидаемый результат:* форма отправилась успешно, всплывающее сообщение об успешном взятие кредита для тура
...
4. Заполнение полей валидными данными и карты со статусом DECLINED
- Нажать на кнопку "Купить в кредит"
- В появившихся полях ввести номер карты: 4444 4444 4444 4442
- Ввести валидные данные в остальные поля
- Нажать на кнопку "Продолжить"
 
 *Ожидаемый результат:* форма отправилась успешно, всплывающее сообщение об отказе во взятие кредита

5. Заполнение поля "Номер карты" картой со статусом APPROVED без пробелов, остальные поля валидными данными
- Нажать на кнопку "Купить"
...
6. Оставление поля "Номер карты" пустым, остальные поля валидными данными
- Нажать на кнопку "Купить"
...
7. Заполнение поля "Номер карты" рандомными цифрами в кол-ве 16
- Нажать на кнопку "Купить"
...
8. Заполнение поля "Номер карты" 15 рандомными цифрами
- Нажать на кнопку "Купить"
...
9. Заполнение поля "Номер карты" 19 рандомными цифрами
- Нажать на кнопку "Купить"
...
10. Заполнение поля "Номер карты" 20 рандомными цифрами
- Нажать на кнопку "Купить"
...
11. Заполнение поля "Номер карты" не цифрами, а другими символами
- Нажать на кнопку "Купить"
...
12. Оставление поля "Месяц" пустым, остальные поля валидными данными
- Нажать на кнопку "Купить"
...
13. Заполнение поля "Месяц" одним символом (цифры от 1-9), остальные поля валидными данными
- Нажать на кнопку "Купить"
...
14. Заполнение поля "Месяц" более 2х цифр
- Нажать на кнопку "Купить"
...
15. Заполнение поля "Месяц" значением 00
- Нажать на кнопку "Купить"
...
16. Заполнение поля "Месяц" значением 13
- Нажать на кнопку "Купить"
...
17. Заполнение поля "Месяц" не цифрами, а другими символами 
- Нажать на кнопку "Купить"
...
18. Заполнение поля "Месяц" предыдущим месяцем, а поле "Год" текущим годом
- Нажать на кнопку "Купить"
...
19. Оставление поля "Год" пустым, остальные поля валидными данными
- Нажать на кнопку "Купить"
...
20. Заполнение поля "Год" одним символом (цифры от 1-9), остальные поля валидными данными
- Нажать на кнопку "Купить"
...
21. Заполнение поля "Год" предыдущим годом
- Нажать на кнопку "Купить"
...
22. Оставление поля "Владелец карты" пустым
- Нажать на кнопку "Купить"
...
23. Заполнение поля "Владелец карты" валидными данными с дефисом
- Нажать на кнопку "Купить"
...
24. Заполнение поля "Владелец карты" валидными данными в нижнем регистре
- Нажать на кнопку "Купить"
...
25. Заполнение поле "Владелец карты" с пробелами в начале и в конце 
- Нажать на кнопку "Купить"
...
26. Заполнение поле "Владелец карты" иностранным языком(не латиницей)
- Нажать на кнопку "Купить"
...
27. Заполнение поле "Владелец карты" цифрами
- Нажать на кнопку "Купить"
...
28. Заполнение поле "Владелец карты" иероглифами
- Нажать на кнопку "Купить"
...
29. Оставление поле "CVC/CVV" пустым
- Нажать на кнопку "Купить"
...
30. Заполнение поле "CVC/CVV" двумя рандомными цифрами
- Нажать на кнопку "Купить"
...
31. Заполнение поле "CVC/CVV" 4 рандомными цифрами
- Нажать на кнопку "Купить"
...
32.  Заполнение поле "CVC/CVV" 3 буквами
- Нажать на кнопку "Купить"
...
33. Заполнение поле "CVC/CVV" символами, знаками препинания
- Нажать на кнопку "Купить"
...
34. Автозаполнение полей при переходе с "Купить" на "Купить в кредит"
- Нажать на кнопку "Купить"
- Ввести валидные данные во все поля
- Нажать на кнопку "Купить в кредит"
  
 *Ожидаемый результат:* форма переключиться, поля останутся заполнены теми же данными

35. Автозаполнение полей при переходе с "Купить в кредит" на "Купить"
- Нажать на кнопку "Купить в кредит"
- Ввести валидные данные во все поля
- Нажать на кнопку "Купить"
...
<u>Провести сценарии с пункта 5-33 по функционалу "Купить в кредит"</u>
